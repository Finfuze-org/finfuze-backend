...
const createUser = async (req,res) => {
    ...
    const isEmail = await pool.query("SELECT email FROM person WHERE email = $1",[email])
    ...
    const newUser = await pool.query("INSERT INTO person (first_name,last_name,email,password,otp,otp_time) VALUES ($1,$2,$3,$4,$5,$6) RETURNING *",[first_name,last_name,email,hashedPassword,hashedOtpCode,otpTime])
